<?php
/**
 * Unit tests for ODAD_Filter_Parser.
 */
...
class FilterParserTest extends TestCase {
    ...
    private function parse( string $expr ): ODAD_AST_Node {
    ...
    public function test_simple_eq_expression(): void {
        ...
        $this->assertInstanceOf( ODAD_AST_Binary::class, $node );
        $this->assertSame( 'eq', $node->op );
        $this->assertInstanceOf( ODAD_AST_Property::class, $node->left );
        $this->assertSame( 'Title', $node->left->path );
        $this->assertInstanceOf( ODAD_AST_Literal::class, $node->right );
    ...
    public function test_and_binds_tighter_than_or(): void {
        ...
        // Left of or: a eq 1
        $left = $node->left;
        $this->assertInstanceOf( ODAD_AST_Binary::class, $left );
        $this->assertSame( 'eq', $left->op );
        $this->assertSame( 'a', $left->left->path );

        // Right of or: and node
        $right = $node->right;
        $this->assertInstanceOf( ODAD_AST_Binary::class, $right );
    ...
    public function test_not_unary(): void {
        ...
        $this->assertInstanceOf( ODAD_AST_Unary::class, $node );
        $this->assertSame( 'not', $node->op );
        $this->assertInstanceOf( ODAD_AST_Binary::class, $node->operand );
    }
    ...
    public function test_in_operator(): void {
        ...
        $this->assertInstanceOf( ODAD_AST_In::class, $node );
        $this->assertInstanceOf( ODAD_AST_Property::class, $node->property );
    ...
    public function test_contains_function(): void {
        ...
        $this->assertInstanceOf( ODAD_AST_Function::class, $node );
        $this->assertSame( 'contains', $node->name );
        $this->assertCount( 2, $node->args );
        $this->assertInstanceOf( ODAD_AST_Property::class, $node->args[0] );
        $this->assertSame( 'Title', $node->args[0]->path );
        $this->assertInstanceOf( ODAD_AST_Literal::class, $node->args[1] );
    ...
    public function test_year_function_in_comparison(): void {
        ...
        $this->assertInstanceOf( ODAD_AST_Binary::class, $node );
        $this->assertSame( 'gt', $node->op );
        $this->assertInstanceOf( ODAD_AST_Function::class, $node->left );
    ...
    public function test_nested_parens_change_precedence(): void {
        ...
        $this->assertInstanceOf( ODAD_AST_Binary::class, $node->left );
