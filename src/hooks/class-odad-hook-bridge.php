...
class ODAD_Hook_Bridge {
    ...
    public function register(): void {
        ...
        if ( is_admin() ) {
            ...
            add_action( 'admin_post_ODAD_save_permission_config',
                fn() => ODAD_container()->get( ODAD_Admin_Permission_Config::class )->save()
            );
        }
    }

    public function on_admin_menu(): void {
        ODAD_container()->get( ODAD_Admin::class )->register_menu();
    }
